...
# Bot အချက်အလက်များ
TOKEN = "8612147363:AAGLX83RBr5WSz5vxAK5-LmMAZDNRGtbesg"
OWNER_ID = 7936016365  
...
def callback_handler(call):
    ...
    if call.data == "btn_scan" or call.data == "btn_find":
        ...
        buy_text = (
            ...
            "• KPay / WavePay: 09984797418 (အမည် - San aye)\n\n"
            "📥 ဝယ်ယူပုံ အဆင့်ဆင့်:\n"
    ...
    # Owner က ငွေလွှဲပြေစာကို လက်ခံ/ငြင်းပယ်ခြင်း (Callback Data handling)
        ...
        if action == "accept":
            ...
            try:
                bot.send_message(target_uid, f"🎉 သင်ဆီငွေလွှဲပြေစာကို Owner မှ အတည်ပြုလိုက်ပါပြီ။ သင့်အကောင့်ထဲသို့ {credits_to_add} Credits ထည့်သွင်းပေးလိုက်ပါပြီ။ လက်ကျန် Credit: {user_credits[target_uid]}", parse_mode="Markdown")
            except:
                pass
